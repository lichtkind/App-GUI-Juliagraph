...
sub new {
    ...
    my $ca_lbl       = Wx::StaticText->new($self, -1, 'A : ' );
    my $cb_lbl       = Wx::StaticText->new($self, -1, 'B : ' );
    my $sa_lbl       = Wx::StaticText->new($self, -1, 'A : ' );
    my $sb_lbl       = Wx::StaticText->new($self, -1, 'B : ' );
    ...
    $start_lbl->SetToolTip('value of iteration variable Z before first iteration');
    ...
    $self->{'button_ca'}   = App::GUI::Juliagraph::Widget::SliderStep->new( $self, 90, 3, 0.3, 2, );
    $self->{'button_cb'}   = App::GUI::Juliagraph::Widget::SliderStep->new( $self, 90, 3, 0.3, 2, );
    $self->{'button_sa'}   = App::GUI::Juliagraph::Widget::SliderStep->new( $self, 90, 3, 0.3, 2, );
    $self->{'button_sb'}   = App::GUI::Juliagraph::Widget::SliderStep->new( $self, 90, 3, 0.3, 2, );
    ...
    $self->{'const_widgets'} = [qw/const_a const_b button_ca button_cb/];
    $self->{'start_widgets'} = [qw/start_a start_b button_sa button_sb/];
    ...
    $const_a_sizer->Add( $ca_lbl,              0, $row, 12);
    ...
    $const_b_sizer->Add( $cb_lbl,              0, $row, 17);
    ...
    $start_a_sizer->Add( $sa_lbl,              0, $row, 17);
    ...
    $start_b_sizer->Add( $sb_lbl,              0, $row, 17);
