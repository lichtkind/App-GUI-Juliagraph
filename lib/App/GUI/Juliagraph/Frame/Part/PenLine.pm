...
package App::GUI::Juliagraph::Frame::Part::PenLine;
...
sub new {
    ...
    $self->{'length'} = App::GUI::Juliagraph::SliderCombo->new( $self, 80, 'Length','length of drawing in full circles',     1,  150,  10);
    $self->{'density'} = App::GUI::Juliagraph::SliderCombo->new( $self, 80, 'Density','x 10 pixel per circle',  1,  400,  100);
